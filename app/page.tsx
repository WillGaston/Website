  ...
  return (
    <MaxWidthWrapper>
      <header className="flex flex-row justify-between max-w-5xl mx-auto px-4 py-3 sm:px-6">
        <a href="/" className = 'text-orange-600 font-semibold text-1xl hover:text-orange-500 underline underline-offset-2'>Home</a>
        <div>
      ...
      <div className = 'py-20 mx-auto text-center flex flex-col items-center max-w-3xl'>
        ...
        <h2 className ='py-5 text-3xl font-semibold tracking-tighter text-gray-600'>
        Student, Bookworm, aspiring Developer.
        </h2>
        <p className = 'py-5 text-2xl font-sans tracking-tighter text-gray-800'>
